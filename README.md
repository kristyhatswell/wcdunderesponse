...
You can download from GitHub this altered underscores template called "wcdunderesponse" and start styling and developing it,
...
If you have chosen to start with wcdunderesponse, then you need to manually change the text domain and prefixes.
You can do this by searching the entire wcdunderesponse folder for "wcdunderesponse" and using search and replace to change it to the name of your theme/text domain.
